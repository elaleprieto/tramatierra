<div class="multimediaCategorias index">
	<h2><?php echo __('Multimedia Categorias'); ?></h2>
	...
	<?php
	foreach ($multimediaCategorias as $multimediaCategoria): ?>
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $multimediaCategoria['MultimediaCategoria']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $multimediaCategoria['MultimediaCategoria']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $multimediaCategoria['MultimediaCategoria']['id']), null, __('Are you sure you want to delete # %s?', $multimediaCategoria['MultimediaCategoria']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
